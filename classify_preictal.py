...
#     df['NB']=score_NB_sum[n]
#     df['SVM']=score_SVM_sum[n]
#     df.to_csv(f'C:\\Users\\wxiong/Documents\\PHD\\combine_features\\performances\\Preictal_classify\\allchannels_June\\raw_30_15min_channels_EEGperformance_Accuracy.csv')
#
#
# for n in range(len(roc_auc_KNN_sum)):
#     df = pd.DataFrame()
...
#     df['NB']=roc_auc_NB_sum[n]
#     df['SVM']=roc_auc_SVM_sum[n]
#     df.to_csv(f'C:\\Users\\wxiong/Documents\\PHD\\combine_features\\performances\\Preictal_classify\\allchannels_June\\raw_30_15min_channels_EEGperformance_AUC.csv')
#
...
#     df['NB']=F1_KNN_sum[n]
#     df['SVM']=F1_KNN_sum[n]
#     df.to_csv(f'C:\\Users\\wxiong/Documents\\PHD\\combine_features\\performances\\Preictal_classify\\allchannels_June\\raw_30_15min_channels_EEGECGperformance_F1.csv')
#
# for n in range(len(recall_KNN_sum)):
#     df = pd.DataFrame()
#     df['KNN']=recall_KNN_sum[n]
#     df['DT']=recall_KNN_sum[n]
#     df['RFT']=recall_KNN_sum[n]
#     df['NB']=recall_KNN_sum[n]
#     df['SVM']=recall_KNN_sum[n]
#     df.to_csv(f'C:\\Users\\wxiong/Documents\\PHD\\combine_features\\performances\\Preictal_classify\\allchannels_June\\raw_30_15min_channels_EEGECGperformance_recall.csv')
